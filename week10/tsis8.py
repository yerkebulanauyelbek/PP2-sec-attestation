...
#скорость встречной машины, случайная 1-5
enemyspeed = random.randint(1,5)
#скорость монет, случайная 1-5
coinspeed = random.randint(1,5)
...
while True:
    ...
    collect = font_small.render(str(coinnumb), True, BLACK)
